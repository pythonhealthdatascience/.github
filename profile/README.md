...
| [stars_wp3_eom_rcc](https://github.com/pythonhealthdatascience/stars_wp3_eom_rcc) | Modifications to the "Exeter Oncology Model: Renal Cell Carcinoma edition (EOM-RCC)" as part of STARS work package 3. |
